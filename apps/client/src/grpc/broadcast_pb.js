...
proto.pq.streaming.games.timer.PlayerListResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.pq.streaming.games.timer.User.toObject, includeInstance)
  };
 ...
 * @return {!Array<!proto.pq.streaming.games.timer.User>}
 */
proto.pq.streaming.games.timer.PlayerListResponse.prototype.getPlayersList = function() {
  return /** @type{!Array<!proto.pq.streaming.games.timer.User>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.pq.streaming.games.timer.User, 1));
};


/**
 * @param {!Array<!proto.pq.streaming.games.timer.User>} value
...
/**
 * @param {!proto.pq.streaming.games.timer.User=} opt_value
 * @param {number=} opt_index
 * @return {!proto.pq.streaming.games.timer.User}
 */
proto.pq.streaming.games.timer.PlayerListResponse.prototype.addPlayers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.pq.streaming.games.timer.User, opt_index);
};
