...
goog.exportSymbol('proto.pq.streaming.games.timer.NextQuestionResponse', null, global);
 ...
 * @constructor
 */
proto.pq.streaming.games.timer.NextQuestionResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.pq.streaming.games.timer.NextQuestionResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.pq.streaming.games.timer.NextQuestionResponse.displayName = 'proto.pq.streaming.games.timer.NextQuestionResponse';
}
 ...
 * @return {string}
 */
proto.pq.streaming.games.timer.Question.prototype.getGameId = function() {
 ...
 * @return {!proto.pq.streaming.games.timer.Question} returns this
 */
proto.pq.streaming.games.timer.Question.prototype.setGameId = function(value) {
 ...
 * @return {!Object}
 */
proto.pq.streaming.games.timer.NextQuestionResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.pq.streaming.games.timer.NextQuestionResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.pq.streaming.games.timer.NextQuestionResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pq.streaming.games.timer.NextQuestionResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.pq.streaming.games.timer.NextQuestionResponse}
 */
proto.pq.streaming.games.timer.NextQuestionResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.pq.streaming.games.timer.NextQuestionResponse;
  return proto.pq.streaming.games.timer.NextQuestionResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.pq.streaming.games.timer.NextQuestionResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.pq.streaming.games.timer.NextQuestionResponse}
 */
proto.pq.streaming.games.timer.NextQuestionResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.pq.streaming.games.timer.NextQuestionResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.pq.streaming.games.timer.NextQuestionResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.pq.streaming.games.timer.NextQuestionResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.pq.streaming.games.timer.NextQuestionResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
