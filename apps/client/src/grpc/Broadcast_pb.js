...
proto.pq.streaming.games.timer.Message.toObject = function(includeInstance, msg) {
  var f, obj = {
    time: jspb.Message.getFieldWithDefault(msg, 1, 0),
    question: (f = msg.getQuestion()) && Question_pb.Question.toObject(includeInstance, f),
...
/**
 * optional pq.qb.questions.Question Question = 2;
 * @return {?proto.pq.qb.questions.Question}
 */
proto.pq.streaming.games.timer.Message.prototype.getQuestion = function() {
  return /** @type{?proto.pq.qb.questions.Question} */ (
    jspb.Message.getWrapperField(this, Question_pb.Question, 2));
};


/**
 * @param {?proto.pq.qb.questions.Question|undefined} value
 * @return {!proto.pq.streaming.games.timer.Message} returns this
*/
...
/**
 * optional pq.qb.questions.Question question = 1;
 * @return {?proto.pq.qb.questions.Question}
 */
proto.pq.streaming.games.timer.StartQuestion.prototype.getQuestion = function() {
  return /** @type{?proto.pq.qb.questions.Question} */ (
    jspb.Message.getWrapperField(this, Question_pb.Question, 1));
};
